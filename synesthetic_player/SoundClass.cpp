...
BOOL SoundClass::StopWaveFile(IDirectSoundBuffer8** dsb8SecondaryBuffer)
{
	HRESULT hResult;

	if (FAILED (hResult = (*dsb8SecondaryBuffer)->Stop()))
		return FALSE;
